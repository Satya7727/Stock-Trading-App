  ...
  return ( 
    <div className="container">
      <div className="row mt-5 ml-4">
        ...
        {/* Your Zerodha Account (Left) */}
        <div className="col-4 p-3 mt-2">
          <h4><i className="fa fa-user" aria-hidden="true"></i> Your Zerodha Account</h4>
        ...
        {/* Console */}
        <div className="col-4 p-3 mt-4">
          <h4><i className="fa fa-terminal" aria-hidden="true"></i> Console</h4>
        ...
        {/* Coin */}
        <div className="col-4 p-3 mt-4">
          <h4><i className="fa fa-coins" aria-hidden="true"></i> Coin</h4>
